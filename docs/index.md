# go-ruby-warden documentation

**Pure-Go, MRI-4.0.5-faithful Ruby warden (no cgo)**

`go-ruby-warden/warden` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `warden`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `warden`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`warden`](https://github.com/go-ruby-warden/warden) | the library — Ruby's `warden` in pure Go |
| [`docs`](https://github.com/go-ruby-warden/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-warden.github.io`](https://github.com/go-ruby-warden/go-ruby-warden.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-warden/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-warden/warden](https://github.com/go-ruby-warden/warden).
